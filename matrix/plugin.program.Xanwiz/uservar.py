...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Xanax[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Xanax.\n\nContact us on at https://example.com/'
...
REPOID = 'repository.Xanax'
# Url to Addons.xml file in your repo folder(this is so we can get the latest version)
REPOADDONXML = 'https://jack7t85.000webhostapp.com/matrix/zips/addons.xml'
# Url to folder zip is located in
REPOZIPURL = 'https://jack7t85.000webhostapp.com/matrix/zips/repository.Xanax'
#########################################################
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR limegreen][B]Xanax[/B][/COLOR]Wizard'
